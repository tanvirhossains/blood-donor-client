...
const BloodBenefit = () => {
    return (
        <section className='my-6 lg:p-24'>
            ...
            {/* -----------------Card of the */}
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10  mt-8 mx-8 m'>
                {/* -------------------card one */}
                <div class="   card   bg-slate-600 shadow-xl h-auto ">
                    <div class=" card-body">
                        <div class="mt-2 ">
                        ...
                        <div className='card-actions justify-center '>
                            <button className='w-full btn btn-error text-white text-xl font-bold hover:text-black '>Join As a Donor
                            </button>
                        </div>

                        {/* <div className=' '> */}
                        {/* </div> */}
                        {/* <button className=' w-5/6 mx-auto btn btn-error text-white text-xl font-bold hover:text-black absolute bottom-4  '>Join As a Donor</button> */}
                    </div>
                </div>
